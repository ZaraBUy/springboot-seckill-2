...
public class GoodsController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response, Model model, User user) {
        ...
        //取缓存
        String html = redisService.get(GoodsKey.getGoodsList, "_", String.class);
        ...
        if (!StringUtils.isEmpty(html)) {
            redisService.set(GoodsKey.getGoodsList, "_", html);
        }
        //结果输出
        return html;
    }
    ...
    public String detail2(HttpServletRequest request, HttpServletResponse response, Model model, User user, @PathVariable("goodsId") long goodsId) {
        ...
        //取缓存
        String html = redisService.get(GoodsKey.getGoodsDetail, "_" + goodsId, String.class);
        if (!StringUtils.isEmpty(html)) {
            return html;
        }
